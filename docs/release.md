...
and referenced by a Cask in `LIANENGUANG/homebrew-tap`.
...
export GITHUB_REPOSITORY="LIANENGUANG/CodexChineseVoice"
export HOMEBREW_TAP_REPOSITORY="LIANENGUANG/homebrew-tap"
```
